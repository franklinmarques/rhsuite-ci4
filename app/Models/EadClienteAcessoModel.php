...
use App\Entities\EadClienteAcesso;

class EadClienteAcessoModel extends AbstractModel
{
	protected $DBGroup              = 'default';
	protected $table                = 'ead_clientes_acessos';
	protected $primaryKey           = 'id';
	protected $useAutoIncrement     = true;
	protected $insertID             = 0;
	protected $returnType           = EadClienteAcesso::class;
