...
use App\Entities\EadClienteTreinamento;

class EadClienteTreinamentoModel extends AbstractModel
{
	protected $DBGroup              = 'default';
	protected $table                = 'ead_clientes_treinamentos';
	protected $primaryKey           = 'id';
	protected $useAutoIncrement     = true;
	protected $insertID             = 0;
	protected $returnType           = EadClienteTreinamento::class;
