...
use App\Entities\IcomPagamentoAprovacao;

class IcomPagamentoAprovacaoModel extends AbstractModel
{
	protected $DBGroup              = 'default';
	protected $table                = 'icom_pagamentos_aprovacoes';
	protected $primaryKey           = 'id';
	protected $useAutoIncrement     = true;
	protected $insertID             = 0;
	protected $returnType           = IcomPagamentoAprovacao::class;
