...
use App\Entities\JobDescriptorRespondente;

class JobDescriptorRespondenteModel extends AbstractModel
{
	protected $DBGroup              = 'default';
	protected $table                = 'job_descriptor_respondentes';
	protected $primaryKey           = 'id';
	protected $useAutoIncrement     = true;
	protected $insertID             = 0;
	protected $returnType           = JobDescriptorRespondente::class;
